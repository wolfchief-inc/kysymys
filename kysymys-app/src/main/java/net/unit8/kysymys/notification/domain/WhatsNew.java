...
public class WhatsNew {
    private static final Arguments5Validator<WhatsNewId, UserId, TemplatePath, Map<String,Object>, LocalDateTime, WhatsNew> validator = ArgumentsValidatorBuilder.of(WhatsNew::new)
            .builder(b -> b
                    ._object(Arguments1::arg1, "whatsNewId", c -> c.notNull())
                    ._object(Arguments2::arg2, "userId", c -> c.notNull())
                    ._object(Arguments3::arg3, "templatePath", c -> c.notNull())
                    ._object(Arguments5::arg5, "postedAt", c -> c.notNull()))
            .build();
